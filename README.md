...
It's similar to playing a game of Sudoku, except there is no board and you have to do it all in your head. Just imagine the difference in your ability to solve the puzzle with and without the board. I can hear the music.. and I want nothing more to improve how we communicate and make better decisions.
